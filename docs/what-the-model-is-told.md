...
1,309 tokens. Generated by `parser.tools()` from `render_config.SPECS` — never
...
| Tool schema | 1,309 | identical every call |
| **Cached prefix** | **2,103** | what `cache_control` protects |
