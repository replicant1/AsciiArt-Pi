...
| 10 | [`with_changes`](../../src/control/render_config.py#L141)`(delta)` | Reached through [`apply`](../../ascii_camera.py#L236), the single way settings ever change and the same call a keypress and the knob make |
