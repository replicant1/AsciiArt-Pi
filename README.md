...
| [A model parse fails and the panel says which kind of failure it was](docs/scenarios/a-model-parse-fails-and-the-panel-says-which-kind-of-failure-it-was.md) | Four infrastructure failures told apart because they call for different actions, a safety refusal because retrying it cannot work, and two answer failures deliberately not |
